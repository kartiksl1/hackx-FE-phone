      ...
      <div className="flex flex-col gap-8 items-center justify-center py-8">
        <div className="text-black text-xl font-normal leading-tight tracking-tight">
          ...
          <div className="text-[#002203] text-sm font-bold leading-none">
            ...
            <div className="text-[#002203] text-sm font-bold  leading-[14px]">Secret Garden</div>
<div className="w-[262px] text-black text-sm font-normal leading-[16.80px]">Some data’s private, some I don’t mind sharing. Think of it as a garden with a neat little fence around it.</div>

            </PrivacyPreference>
            <PrivacyPreference backgroundImage={""}>
            <div className="text-[#002203] text-sm font-bold  leading-[14px]">Wide Open Spaces</div>
<div className="w-[262px] text-black text-sm font-normal leading-[16.80px]">I'm cool with sharing! My data is like a friendly neighbourhood park—open and inviting.</div>
